{
  ...
  environment.shellAliases = {
    ...
    nixos-update="cd /etc/nixos/chris/ && git pull && nixos-rebuild build --upgrade && echo && nvd diff /run/current-system ./result ; echo ; echo \"Run:\" ; echo; echo \"nixos-rebuild switch\"; echo; echo \"to activate\"; echo ; date";
